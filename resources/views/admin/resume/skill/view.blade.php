            ...
            <div class="table-responsive">
                <table id="myTable" class="table card-table display dataTable table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-capitalize">{{$listData->category}}</td>
                            <td class="text-capitalize">{{$listData->name}}</td>
                            <td><img src="{{url($listData->image)}}" width="30" height="30" alt="logo" /></td>
                            ...
                            <td>
                                <a class="btn btn-primary btn-icon btn-sm rounded-pill ms-2" href="{{url('skill/edit/'.$listData->id)}}" title="Edit" role="button">
                                  <i class="fa fa-edit"></i>
                                </a>
                                <a class="btn btn-danger btn-icon btn-sm rounded-pill ms-2" href="{{url('skill/delete/'.$listData->id)}}" title="Delete" role="button">
