        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="row g-3" action="{{url('skill/update/'.$list->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-12 col-lg-6">
                                ...
                                <select class="form-control" id="category" required name="category">
                                    <option value="development" @if($list->category == "development") selected @endif>Development</option>
                                    <option value="other" @if($list->category == "other") selected @endif>Other</option>
                                </select>
                            ...
                            <div class="col-md-12 col-lg-6">
                                ...
                                <input type="text" class="form-control" id="name" placeholder="html" value="{{$list->name}}" required name="name">
                                @if($errors->has('name'))
                            ...
                            <div class="col-md-12 col-lg-6">
                                ...
                                <input type="file" class="form-control" id="image1" required name="image" accept=".png,.jpg,.jpeg">
                                @if($errors->has('image'))
                            ...
                            <div class="col-md-12 col-lg-6">
                                ...
                                <input type="number" class="form-control" id="percentage" placeholder="Example 60" value="{{$list->percentage}}" name="percentage">
                            ...
                            <div class="col-md-12 col-lg-6">
                                <label for="percentage" class="form-label">Status<span class="text-danger">*</span></label>
                                <select class="form-control" id="percentage" required name="status">
