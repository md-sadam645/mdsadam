        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="row g-3" action="{{url('experience/add')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-12 col-lg-6">
                                <label for="designation" class="form-label">Designation<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="designation" placeholder="Php laravel developer" name="designation" required>
                            ...
                            <div class="col-md-12 col-lg-6">
                                ...
                                <input type="text" class="form-control" id="company_name" placeholder="amazingWebDesign" required name="company_name">
                            ...
                            <div class="col-md-12 col-lg-6">
                                ...
                                <input type="text" class="form-control" id="location" placeholder="bhopal, mp" required name="location">
                            ...
                            <div class="col-md-12 col-lg-12">
                                ...
                                <textarea class="form-control" rows="6" placeholder="Enter Description" id="desc" name="description" required></textarea>
