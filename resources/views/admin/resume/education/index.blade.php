        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="row g-3" action="{{url('education/add')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-md-12 col-lg-6">
                                ...
                                <input type="text" class="form-control" id="organization_name" placeholder="Enter Organization Name" required name="organization_name">
                            ...
                            <div class="col-md-12 col-lg-6">
                                ...
                                <input type="text" class="form-control" id="duration" placeholder="Example (2020 - 2023)" name="duration" required>
                            ...
                            <div class="col-md-12 col-lg-6">
                                ...
                                <input type="text" class="form-control" id="grade" placeholder="Example 2.4 / 4" required name="grade">
                                @if($errors->has('grade'))
                            ...
                            <div class="col-md-12 col-lg-6">
                                ...
                                <input type="number" class="form-control" step="0.01" id="percentage" placeholder="Example 60" required name="percentage">
                            ...
                            <div class="col-md-12 col-lg-12">
                                ...
                                <textarea class="form-control" rows="6" placeholder="Enter Description" id="desc" rows="5" name="description" required></textarea>
