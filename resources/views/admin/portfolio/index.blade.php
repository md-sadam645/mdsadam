        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="row g-3" action="{{url('portfolio/add')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-md-12 col-lg-6">
                                ...
                                <input type="url" class="form-control" id="plink" placeholder="Enter Project Link" required name="plink">
                                @if($errors->has('plink'))
                            ...
                            <div class="col-md-12 col-lg-6">
                                ...
                                <input type="file" class="form-control" id="profile" required name="profile" accept=".png, .jpg, .jpeg">
                            ...
                            <div class="col-md-12 col-lg-6">
                                ...
                                <input type="file" class="form-control" id="slider" multiple required name="slider[]" accept=".png, .jpg, .jpeg">
