                ...
                <div class="testimonial-activation testimonial-pb mb--30">
                        ...
                        <div class="inner">
                            <div class="card-info">
                                <div class="card-thumbnail">
                                    <img src="{{url('assets/frontend/images/testimonial/final-home--1st.png')}}" alt="Testimonial-image">
                                </div>
                            ...
                            <div class="card-description">
                                <div class="title-area">
                                    ...
                                    <div class="rating">
                                        <img src="{{url('assets/frontend/images/icons/rating.png')}}" alt="rating-image">
                                        <img src="{{url('assets/frontend/images/icons/rating.png')}}" alt="rating-image">
                                        <img src="{{url('assets/frontend/images/icons/rating.png')}}" alt="rating-image">
                                        <img src="{{url('assets/frontend/images/icons/rating.png')}}" alt="rating-image">
                                        <img src="{{url('assets/frontend/images/icons/rating.png')}}" alt="rating-image">
                    ...
                    <div class="testimonial mt--50 mt_md--40 mt_sm--40">
                        <div class="inner">
                            <div class="card-info">
                                <div class="card-thumbnail">
                                    <img src="{{url('assets/frontend/images/testimonial/final-home--2nd.png')}}" alt="Testimonial-image">
                                </div>
                                <div class="card-content">
                    ...
                    <div class="testimonial mt--50 mt_md--40 mt_sm--40">
                        <div class="inner">
                            <div class="card-info">
                                <div class="card-thumbnail">
                                    <img src="{{url('assets/frontend/images/testimonial/final-home--3rd.png')}}" alt="Testimonial-image">
                                </div>
                                <div class="card-content">
                    ...
                    <div class="testimonial mt--50 mt_md--40 mt_sm--40">
                        <div class="inner">
                            <div class="card-info">
                                <div class="card-thumbnail">
                                    <img src="{{url('assets/frontend/images/testimonial/final-home--4th.png')}}" alt="Testimonial-image">
                                </div>
                                <div class="card-content">
                    ...
                    <div class="testimonial mt--50 mt_md--40 mt_sm--40">
                        <div class="inner">
                            <div class="card-info">
                                <div class="card-thumbnail">
                                    <img src="{{url('assets/frontend/images/testimonial/final-home--5th.png')}}" alt="Testimonial-image">
                                </div>
                                <div class="card-content">
