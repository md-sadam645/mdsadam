                            ...
                            <div class="row">
                                        ...
                                        <ul class="skill-share d-flex liststyle">
                                            @for($i = 0; $i < count($allSkill) ; $i++)
                                                <li class="border d-flex justify-content-center align-items-center">
                                                    <i class="{{$allSkill[$i]}}" style="font-size: 30px;"></i>
                                                </li>
                                            @endfor
                                        </ul>
                                    </div>
                                ...
                                <div class="col-lg-12 mt-5 col-md-6">
                                    <div class="social-share-inner-left">
                                        <a href="{{$master->resume}}" download class="rn-btn thumbs-icon">
                                            Download Resume
                                        </a>
                                    </div>
                                </div>
    ...
    <div class="row mt--50">
        <div class="col-lg-12">
            <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500" data-aos-once="true" class="portfolio-wrapper portfolio-slick-activation slick-arrow-style-one rn-slick-dot-style">
                ...
                <div class="rn-portfolio-slick portfolio-con slide-width" contentid="{{$portfolioData->id}}">
                    <div class="rn-portfolio" data-bs-toggle="modal" data-bs-target="#portfolioModal">
                        <div class="inner">
                            <div class="thumbnail">
                                <a href="javascript:void(0)">
                                    <img src="{{url($portfolioData->profile)}}" alt="{{$portfolioData->profile}}">
                                </a>
                            </div>
                            <div class="content">
                                <div class="category-info">
                                    <div class="category-list">
                                        <a href="javascript:void(0)">{{$portfolioData->category}}</a>
                                    </div>
                                    <div class="meta">
                                        <span><a href="javascript:void(0)"><i class="fa-solid fa-clock"></i></a>
                                            @php echo date_format($portfolioData->created_at,"Y-M-d") @endphp
                                        </span>
                                    </div>
                                </div>
                                <h4 class="title text-capitalize">
                                    <a href="javascript:void(0)">{{$portfolioData->pname}}
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="col-6 col-lg-3 ps-3 ps-md-0 pe-3 pe-lg-5 mx-0 mb-lg-5 mb-4">
                                                        <div class="border p-3 d-flex align-items-center" style="border-radius:4px;">
                                                            <img src="{{url($developmentData->image)}}" alt="{{$developmentData->image}}" width="35" height="35" style="border-radius:4px;" /> &nbsp;
                                                    ...
                                                    <div class="col-6 col-lg-3 ps-3 ps-md-0 pe-3 pe-lg-5 mx-0 mb-lg-5 mb-4">
                                                        <div class="border p-3 d-flex align-items-center" style="border-radius:4px;">
                                                            <img src="{{url($otherData->image)}}" alt="{{$otherData->image}}" width="35" height="35" style="border-radius:4px;" /> &nbsp;
                ...
                <div class="contact-about-area">
                    ...
                    <div class="social-area">
                        ...
                        <div class="social-icone">
                            <a href="{{$master->github_link}}" target="_blank"><i class="fa-brands fa-github"></i></a>
                            <a href="{{$master->linkedin_link}}" target="_blank"><i class="fa-brands fa-linkedin"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-body">
                ...
                <div class="news-details">
                    <div class="button-group mt--20">
                        ...
                        <a href="" class="rn-btn" id="project-link" target="_blank">
